...
#ifdef TASK5_MyThirdPersonChar_generated_h
#error "MyThirdPersonChar.generated.h already included, missing '#pragma once' in MyThirdPersonChar.h"
#endif
...
public: \
	DECLARE_CLASS(AMyThirdPersonChar, ACharacter, COMPILED_IN_FLAGS(0 | CLASS_Config), CASTCLASS_None, TEXT("/Script/Task5"), NO_API) \
...
#define Task5_Source_Task5_MyThirdPersonChar_h_15_STANDARD_CONSTRUCTORS \
	...
	DECLARE_VTABLE_PTR_HELPER_CTOR(NO_API, AMyThirdPersonChar); \
	DEFINE_VTABLE_PTR_HELPER_CTOR_CALLER(AMyThirdPersonChar); \
private: \
	/** Private move- and copy-constructors, should never be used */ \
	NO_API AMyThirdPersonChar(AMyThirdPersonChar&&); \
	NO_API AMyThirdPersonChar(const AMyThirdPersonChar&); \
public:
...
template<> TASK5_API UClass* StaticClass<class AMyThirdPersonChar>();

#undef CURRENT_FILE_ID
#define CURRENT_FILE_ID Task5_Source_Task5_MyThirdPersonChar_h
